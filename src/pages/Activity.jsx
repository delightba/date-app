                        ...
                        <div className="group__bottom--body bg-white">
                          <div className="group__bottom--group">
                            <div className="row g-4 justify-content-center mx-12-none row-cols-1">
                                ...
                                <div className="activity__item">
                                  <div className="activity__inner">
                                    ...
                                    <div className="activity__content">
                                      <h5><a href="member-single.html">Daniel Becker </a><span>became a registered member</span></h5>
                                      <p>2 days ago</p>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div className="col">
                                <div className="activity__item">
                                  <div className="activity__inner">
                                    ...
                                    <div className="activity__content">
                                      <h5><a href="member-single.html">Thorsten Schwab </a><span>became a registered member</span></h5>
                                      <p>2 days ago</p>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div className="col">
                                <div className="activity__item">
                                  <div className="activity__inner">
                                    ...
                                    <div className="activity__content">
                                      <h5><a href="member-single.html">Leah Friedman </a><span>became a registered member</span></h5>
                                      <p>2 days ago</p>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div className="col">
                                <div className="activity__item">
                                  <div className="activity__inner">
                                    ...
                                    <div className="activity__content">
                                      <h5><a href="member-single.html">Maximilian Schmidt </a><span>became a registered member</span></h5>
                                      <p>2 days ago</p>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div className="col">
                                <div className="activity__item">
                                  <div className="activity__inner">
                                    ...
                                    <div className="activity__content">
                                      <h5><a href="member-single.html">Michelle Foerster </a><span>became a registered member</span></h5>
                                      <p>2 days ago</p>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div className="col">
                                <div className="activity__item">
                                  <div className="activity__inner">
                                    <div className="activity__thumb">
                                      <a href="member-single.html"><img src="assets/images/member/home2/07.jpg" alt="dating thumb" /></a>
                                    </div>
                                    <div className="activity__content">
                                      <h5><a href="member-single.html">Tom Frankfurter </a><span>became a registered member</span></h5>
                                      <p>2 days ago</p>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div className="col">
                                <div className="activity__item">
                                  <div className="activity__inner">
                                    <div className="activity__thumb">
                                      <a href="member-single.html"><img src="assets/images/member/home2/08.jpg" alt="dating thumb" /></a>
                                    </div>
                                    <div className="activity__content">
                                      <h5><a href="member-single.html">Karolin Thalberg </a><span>became a registered member</span></h5>
                                      <p>2 days ago</p>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div className="col">
                                <div className="activity__item">
                                  <div className="activity__inner">
                                    <div className="activity__thumb">
                                      <a href="member-single.html"><img src="assets/images/member/home2/09.jpg" alt="dating thumb" /></a>
                                    </div>
                                    <div className="activity__content">
                                      <h5><a href="member-single.html">Christian Nadel </a><span>became a registered member</span></h5>
                                      <p>2 days ago</p>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div className="col">
                                <div className="activity__item">
                                  <div className="activity__inner">
                                    <div className="activity__thumb">
                                      <a href="member-single.html"><img src="assets/images/member/home2/10.jpg" alt="dating thumb" /></a>
                                    </div>
                                    <div className="activity__content">
                                      <h5><a href="member-single.html">Stefanie Farber </a><span>became a registered member</span></h5>
                                      <p>2 days ago</p>
                                    </div>
                                    <div className="activity__item">
                                      <div className="activity__inner">
                              ...
                              <div className="col">
                                <div className="activity__item">
                                  <div className="activity__inner">
                                    ...
                                    <div className="activity__content">
                                      <h5><a href="member-single.html">Christine Winkel </a><span>became a registered member</span></h5>
                                      <p>2 days ago</p>
                                      <p>Nice ❤</p>
                                    </div>
                                  </div>
                            ...
                            <div className="text-center mt-5">
                              <a href="#" className="default-btn reverse"><span><i className="fa-solid fa-spinner" /> Load More</span></a>
                            </div>
                          </div>
                        </div>
                      </div>
