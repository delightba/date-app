                        ...
                        <article>
                            ...
                            <div className="blog__inner">
                              ...
                              <div className="blog__content">
                                ...
                                <ul className="blog__date">
                                  ...
                                  <li><span><i className="fa-solid fa-user" /><a href="#">Rajib Raj</a></span></li>
                                ...
                                <div className="tags-area">
                                  ...
                                  <ul className="share lab-ul justify-content-center">
                                    <li>
                                      <a href="#" className="facebook"><i className="fa-brands fa-facebook-f" /></a>
                                    </li>
                                    <li>
                                      <a href="#" className="dribble"><i className="fa-brands fa-dribbble" /></a>
                                    </li>
                                    <li>
                                      <a href="#" className="twitter"><i className="fa-brands fa-twitter" /></a>
                                    </li>
                                    <li>
                                      <a href="#" className="google"><i className="fa-brands fa-google" /></a>
                                    </li>
                                  </ul>
                                </div>
                              </div>
                          ...
                          <div className="article-pagination">
                            <div className="prev-article">
                              <a href="#"><i className="icofont-rounded-double-left" />Previous Article</a>
                              <p>Evisculate Parallel Processes via Technica Sound Models Authoritative</p>
                            </div>
                            <div className="next-article">
                              <a href="#">Next Article <i className="icofont-rounded-double-right" /></a>
                          ...
                          <div className="author">
                            ...
                            <div className="author__content">
                              <h6 className="mb-2">Rajib Ahmed</h6>
                              ...
                              <div className="social-media">
                                <a href="#" className="twitter"><i className="fa-brands fa-twitter" /></a>
                                <a href="#" className="behance"><i className="fa-brands fa-behance" /></a>
                                <a href="#" className="instagram"><i className="fa-brands fa-instagram" /></a>
                                <a href="#" className="vimeo"><i className="fa-brands fa-vimeo-v" /></a>
                                <a href="#" className="linkedin"><i className="fa-brands fa-linkedin-in" /></a>
                              </div>
                            </div>
                          </div>
                          <div className="comments">
                            <h4 className="comment-title">02 Comment</h4>
                                  ...
                                  <div className="com-content">
                                    <div className="com-title">
                                      ...
                                      <span className="reply">
                                        <a className="comment-reply-link" href="#"><i className="icofont-reply-all" />Reply</a>
                                      </span>
                                    </div>
                          ...
                          <div className="comment-respond">
                            ...
                            <div className="add-comment">
                              <form action="#" className="comment-form">
                                ...
                                <textarea name="comment" rows={7} placeholder="Type Here Your Comment*" defaultValue={""} />
